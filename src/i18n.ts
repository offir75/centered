  ...
  he: {
    ...
    wheelOfLife: {
      intro: {
        title: 'גלגל החיים',
        description:
          'זהו כלי למודעות, לא לביקורת עצמית – אין דבר כזה חיים מושלמים. לפניכם 8 תחומי חיים. דרגו אותם אחד אחרי השני, ובסוף תוכלו לראות בבירור לאן האנרגיה שלכם זורמת, ואיפה היא מבקשת להשתחרר.',
        cta: 'בוא נתחיל',
      },
      ...
      domainDescriptions: {
        work: {
          ...
          long: 'אם אתם עובדים: האם העשייה שלכם ממלאת אתכם בסיפוק ומשמעות, או שהיא מקור מתמיד לשחיקה, לחץ, ופחד מפיטורים?\n\nאם אינכם עובדים: עד כמה החיפוש אחר עבודה, או עצם המצב, מייצרים אצלכם חרדה כלכלית ותחושת חוסר ערך?',
        },
        partnership: {
          short: 'מערכת היחסים הרומנטית שלכם – כמה קשב אתם מקדישים לה, והאם היא מרחב בטוח או מקור לכאב רגשי?',
        ...
        family: {
          short: 'הקשר עם הילדים, ההורים והאחים שלכם – כמה אנרגיה זה דורש, ועד כמה זה מביא לכם שקט או מועקה?',
          long: 'אם יש לכם ילדים: האם ההורות זורמת בהרמוניה, או שהיא מלווה לעיתים קרובות ברגשות אשם ולחץ? אם אין לכם ילדים: עד כמה הכמיהה למשפחה משפיעה על היומיום שלכם?\n\nבנוסף, איך נראה הקשר עם ההורים והאחים שלכם? האם הם עוגן של תמיכה, או מקור מתמיד לחיכוך, ציפיות ושאיבת אנרגיה נפשית?',
        },
        body: {
          short: 'כמה זמן אתם משקיעים בטיפוח ובבריאות הגוף שלכם, ואיך אתם מרגישים בתוכו?',
          long: 'כאן נכלל כל הזמן שאתם משקיעים בטיפוח ואסתטיקה (שיער, איפור, קוסמטיקה, ביגוד), וכן בכושר, תזונה ותורים לרופאים.\n\nהאם אתם מרגישים בנוח בעור שלכם ואוהבים את הגוף, או שאתם מתמודדים עם דימוי גוף נמוך, הלקאה עצמית על המשקל או אכילה רגשית?',
        },
        leisure: {
          short: 'הזמן שלכם פשוט ליהנות, בלי שום מטרה. הרגעים שבהם \'הילד הפנימי\' שלכם מקבל אישור פשוט לשחק.',
